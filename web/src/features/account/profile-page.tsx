...
type ProfileTab = 'general' | 'security' | 'social-links' | 'delete-account'
    ...
    <div className="oecs-settings-wide mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-10 md:px-6">
      ...
      <div className="flex flex-col gap-8 md:flex-row">
        ...
        <div className="min-w-0 flex-1">
          {/* Kept mounted across every tab (not conditionally rendered around this
              block) - Settings wraps the flow in Ory's own context, and DeleteAccountSection
              doesn't depend on it, so there's no reason to remount it on tab switches. */}
